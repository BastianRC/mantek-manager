...
class CreateMachineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category_id' => ['required', 'integer', 'exists:machine_categories,id'],
            'machine_model' => ['required', 'string', 'max:200'],
            ...
            'status' => ['required', Rule::in(MachineStatus::validStatuses())],
    ...
    public function messages(): array
    {
        return [
            ...
            'machine_model.required' => 'The model is required.',
